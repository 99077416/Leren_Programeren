...
answer = input_int("Hoeveel personen?",1,MAX_TICKETS)
...
if vr_vip_ordered:
  answer = input_int('hoeveel VR-VIP seats?',0,nr_tickets)
  nr_vr_vip_seats = int(answer)
  answer = input_int('hoeveel minuten in de VR-VIP-seats?',5,MAX_VR_VIP_SEAT_TIME)
...
answer = input_int("Hoeveel cola?",0,nr_tickets)
nr_cola = int(answer)

answer = input_int("Hoeveel popcorn?",0,nr_tickets)
