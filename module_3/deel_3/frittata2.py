...
print(f'{str_amount_fraction(amount_milk)} {str_single_plural(amount_milk,TXT_CUPS)} {TXT_MILK}')
print(f'{str_amount_fraction(amount_salt)} {str_single_plural(amount_salt, TXT_TEASPOONS)} {TXT_SALT}')
print(f'{str_amount_fraction(amount_pepper)} {str_single_plural(amount_pepper,TXT_TEASPOONS)} {TXT_PEPPER}')
print(f'{str_amount_fraction(amount_oil)} {str_single_plural(amount_oil,TXT_SPOONS)} {TXT_OIL}')
...
print(f'{str_amount_fraction(amount_spinach)} {str_single_plural(amount_spinach,TXT_CUPS)} {TXT_SPINACH}')
